            ...
            <div
                className={twMerge(
                    clsx(
                        ...
                        {
                            "transition delay-[400ms] ease-in-out bg-gray-600 border-slate-950 motion-safe:animate-[xRotate_700ms_ease-in-out]":
                                isGuessComplete,
                        },
                        {
            ...
            <div
                className={twMerge(
                    clsx(
                        ...
                        {
                            "transition delay-[700ms] ease-in-out bg-gray-600 border-slate-950 motion-safe:animate-[xRotate_700ms_ease-in-out_300ms]":
                                isGuessComplete,
                        },
                        {
            ...
            <div
                className={twMerge(
                    clsx(
                        ...
                        {
                            "transition delay-[1000ms] ease-in-out bg-gray-600 border-slate-950 motion-safe:animate-[xRotate_700ms_ease-in-out_600ms]":
                                isGuessComplete,
                        },
                        {
            ...
            <div
                className={twMerge(
                    clsx(
                        ...
                        {
                            "transition delay-[1300ms] ease-in-out bg-gray-600 border-slate-950 motion-safe:animate-[xRotate_700ms_ease-in-out_900ms]":
                                isGuessComplete,
                        },
                        {
            ...
            <div
                className={twMerge(
                    clsx(
                        ...
                        {
                            "transition delay-[1600ms] ease-in-out bg-gray-600 border-slate-950 motion-safe:animate-[xRotate_700ms_ease-in-out_1200ms]":
                                isGuessComplete,
                        },
                        {
